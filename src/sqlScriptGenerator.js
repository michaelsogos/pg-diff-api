const hints = {
	addColumnNotNullableWithoutDefaultValue:
		" --WARN: Add a new column not nullable without a default value can occur in a sql error during execution!",
	changeColumnDataType:
		" --WARN: Change column data type can occur in a casting error, the suggested casting expression is the default one and may not fit your needs!",
	dropColumn: " --WARN: Drop column can occur in data loss!",
	potentialRoleMissing:
		" --WARN: Grant\\Revoke privileges to a role can occur in a sql error during execution if role is missing to the target database!",
	identityColumnDetected: " --WARN: Identity column has been detected, an error can occur because constraints violation!",
	dropTable: " --WARN: Drop table can occur in data loss!",
};
